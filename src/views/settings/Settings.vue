          ...
          <v-list lines="two" density="compact">
            <v-list-item
              v-for="config in providerConfigs.filter(
                (x) =>
                  x.type == ProviderType.MUSIC && x.domain in availableProviders
              )"
              ...
              <template v-slot:append>
                <div class="listitem-actions">
                  ...
                  <div class="listitem-action" v-if="!config.enabled">
                    <v-tooltip location="top end" origin="end center">
                      <template #activator="{ props: tooltip }">
                        <v-icon v-bind="tooltip" color="grey"
                          >mdi-cancel</v-icon
                        >
                      </template>
                  ...
                  >
                    <v-tooltip location="top end" origin="end center">
                      ...
                      <span
                        v-if="api.providers[config.instance_id]?.last_error"
                        >{{
                          api.providers[config.instance_id]?.last_error
                        }}</span
                      >
                    ...
                    <v-menu location="bottom end">
                      ...
                      <v-list>
                        ...
                        <v-list-item
                          ...
                          prepend-icon="mdi-cog"
                          :href="
                            availableProviders[config.domain].documentation
                          "
                          target="_blank"
                        >
                        </v-list-item>
                        <v-list-item
                          ...
                          prepend-icon="mdi-cog"
                          @click="
                            api.startSync(undefined, [config.instance_id])
                          "
                        >
                        </v-list-item>
                        <v-list-item
