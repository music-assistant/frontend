...
defineOptions({
  name: "GenreIconSidebar",
});

// Sidebar passes stroke-width=2. We scale ×2 to compensate for the
// larger coordinate space (64 units vs ArtistIcon's 26 units).
