...
const routes = [
  ...
  { name: "album", path: "/albums/:provider/:item_id", component: AlbumDetails, props: true },
  { name: "track", path: "/tracks/:provider/:item_id", component: TrackDetails, props: true },
  { name: "radio", path: "/radio/:provider/:item_id", component: RadioDetails, props: true },
  {
    name: "playlist",
